...
const AboutUsPage = () => {
  ...
  return (
    <Box textAlign="center" marginTop='5rem'>
      ...
      <Box mt={4} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center',fontFamily: 'serif, system-ui '}}>
      
        <Box style={{ width: '50%', textAlign: 'Justify',marginLeft:'100px',fontFamily: 'system-ui' }}>
         ...
         <Typography> They are fully biodegradable, meaning they can naturally decompose without causing harm to the environment.</Typography>
          
         <Typography>They are a safe and healthy option for serving food, as they do not leach harmful substances into the food.</Typography> 
...
//   <div className="col-lg-6 col-md-8 px-0 da-project-1" data-aos="zoom-in">
//           <img src={sl18} alt="Project 1" height='400px' width='400px'/>
//         </div>
